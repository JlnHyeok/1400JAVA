...
public class C02MoonBangguMain {
	...
	public static void ShowInfo() {
		System.out.println("샤프의 재고량 : "+Moonbanggu.scount);
		System.out.println("연필의 재고량 : "+Moonbanggu.pcount);
	}
	
	public static void main(String[] args) {
		
		sharp ob1 = (sharp)ReqMoonbanggu("샤프");	// sharp ob1 =상위클래스 참조변수
		sharp ob2 = (sharp)ReqMoonbanggu("샤프");	// sharp ob1 =상위클래스 참조변수
		pencil ob3 = (pencil)ReqMoonbanggu("연필");	// sharp ob1 =상위클래스 참조변수
		ob1.write();
		ShowInfo();
