...
//		  byte var7 = -129; 	// 불가능 이유 생각~ 
		  ...
		  // short : 2byte 정수 (음수 저장 o) 							범위 : -32768~32767
		  // char  : 2byte 정수 (음수 저장 x 1문자 저장용도) 	범위 : 0~65535
		  
//		  char ndata1 = 60000;
//		  short ndata2 = ndata1; 		// 큰 범위인 수를 작은 범위에 억지로 넣으려하면 손실 발생한다.
		  
		  // long : 8byte 정수 (음수 저장 o)
		  // 리터럴 접미사 : l , L
		  ...
		  // 지수형 표현방식
		  double num1 = 3e6;		// 3 x 10^6
		  System.out.println(num1);
		  double num2 = 3e-2;		// 3 x 10^-2
